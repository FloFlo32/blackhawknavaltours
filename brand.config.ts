...
export const brand = {
  ...
  name: "Blackhawk Boat Tours",

  /** One-line value prop. Used in the hero sub-headline + meta description. */
  tagline: "Fast Boats. Big City. YOUR TOUR.",

  /** Longer description for SEO / Open Graph. ~150 chars is ideal. */
  description:
    "Blackhawk Boat Tours offers thrilling Chicago River and Lake Michigan adventures aboard military-grade vessels. Enjoy skyline views, private charters, family-friendly experiences, and expert-guided high-speed boat tours.",

  /** Primary domain WITHOUT protocol. `/build` sets this to <project>.getyetti.com. */
  domain: "blackhawknavaltours.getyetti.com",
  ...
  social: {
    github: "FloFlo32/blackhawknavaltours",
    x: "yourhandle",
    email: "blackhawkboattours@gmail.com",
  },
  ...
  contact: {
    whatsapp: "",
    phone: "(312) 900-4604",
    address: '2601 N Cannon Dr, Chicago, IL 60614 Dock "A"',
    mapQuery: "2601 N Cannon Dr, Chicago, IL 60614",
  },
} as const;
